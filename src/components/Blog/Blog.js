      ...
      <div className="row mt-1 g-4">
        ...
        <div className="col-12">
          <div className="card rounded-0">
            <div className="card-body text-center">
              ...
              <p>
                Both props and state are plain JavaScript objects. While both of
                them hold information that influences the output of render, they
                are different in their functionality with respect to component.
        ...
        <div className="col-12">
          <div className="card rounded-0">
            <div className="card-body text-center">
              <h4 className="card-title">
                What is the use of useEffect other than fetching data?
              </h4>
              <p>
                {" "}
                By using useEffect Hook, we tell React that your component needs
                to do something after render. React will remember the function
                you passed (we'll refer to it as our “effect”), and call it
